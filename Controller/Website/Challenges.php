 ...
 */
    ...
    function    displayChallenge(\Challenge\Challenge $challenge) {
        ...
        $src .=             '<div class="global-image-inner-wrap" style="background-image:url(img/avatar.jpg);"></div></a>';
        $src .=         '<a class="global-image-outer-wrap global-image-outer-wrap--game-medium" href="/challenge/'.$challenge->getId().'">';
        $src .=         '<div class="global-image-inner-wrap" style="background-image:url(img/chall.jpg);"></div></a>';
        $src .=     '</div>';
        $src .= '</div>';
        echo $src;
    }
